...
export class MemStorage implements IStorage {
  ...
  async getProjectTemplates() {
    return [
      { id: randomUUID(), name: "React + TypeScript", description: "Modern React app with TypeScript", category: "Frontend" },
      { id: randomUUID(), name: "Express API", description: "RESTful API with Express", category: "Backend" },
      { id: randomUUID(), name: "Full Stack", description: "Complete React + Express application", category: "Full Stack" }
    ];
  }

  async getActiveProjects() {
    return [
      { id: randomUUID(), name: "Vibe Analytics Dashboard", status: "active", progress: 78, team: ["Camila Pisano"] },
      { id: randomUUID(), name: "VibeMotors CRM", status: "active", progress: 65, team: ["Camila Pisano", "Marco Silva"] }
    ];
  }

  async getArchivedProjects() {
    return [
      { id: randomUUID(), name: "Legacy Client Portal", status: "archived", completedAt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000) }
    ];
  }

  async getAnalyticsData() {
    return {
      commitActivity: { daily: [], weekly: [] },
      performanceMetrics: { codeQuality: [], buildTimes: [] }
    };
  }

  async getCodeReviews() {
    return [
      { id: randomUUID(), title: "Add payment integration", status: "pending", author: "Camila Pisano" },
      { id: randomUUID(), title: "Update dashboard UI", status: "approved", author: "Marco Silva" }
    ];
  }
...
// Mock commits data reflecting building Vibe Coder app
const mockCommits = [
  {
    id: "commit-1",
    hash: "a7b3d4e",
    message: "feat: implement advanced dashboard analytics with AI insights",
    author: "You",
    timestamp: new Date(Date.now() - 1 * 60 * 60 * 1000),
    branch: "feature/vibe-dashboard",
    files: ["client/src/pages/dashboard.tsx", "client/src/lib/analytics-utils.ts"],
    additions: 234,
    deletions: 12,
    impact: "high",
    project: "vibe-coder",
  ...
  },
  {
    id: "commit-2", 
    hash: "f9c2a1b",
    message: "refactor: reorganize sidebar navigation for better UX",
    author: "You",
    timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000),
    branch: "refactor/sidebar-navigation",
    files: ["client/src/components/navigation/app-sidebar.tsx"],
    additions: 89,
    deletions: 45,
    impact: "medium",
    project: "vibe-coder",
  ...
  },
  {
    ...
    branch: "feature/projects-hub",
    files: ["client/src/pages/projects.tsx", "client/src/pages/projects/templates.tsx"],
    additions: 445,
    deletions: 23,
    impact: "high",
    project: "vibe-coder",
  ...
  },
  {
    id: "commit-4",
    hash: "b4f6e9d",
    message: "style: enhance glassmorphism effects and vibe theming system",
    author: "You",
    timestamp: new Date(Date.now() - 5 * 60 * 60 * 1000),
    branch: "style/glassmorphism-vibe",
    files: ["client/src/index.css", "client/src/components/ui/theme-provider.tsx"],
    additions: 156,
    deletions: 78,
    impact: "medium",
    project: "vibe-coder",
  ...
  },
  {
    id: "commit-5",
    hash: "c3a8f2d",
    message: "fix: resolve WebSocket connection stability for real-time updates",
    author: "You",
    timestamp: new Date(Date.now() - 6 * 60 * 60 * 1000),
    branch: "fix/websocket-stability",
    files: ["client/src/hooks/use-websocket.ts", "server/index.ts"],
    additions: 67,
    deletions: 34,
    impact: "critical",
    project: "vibe-coder",
  ...
  },
  {
    id: "commit-6",
    hash: "d9e7f1c",
    message: "feat: implement AI-powered insights engine with dynamic metrics",
    author: "You",
    timestamp: new Date(Date.now() - 8 * 60 * 60 * 1000),
    branch: "feature/ai-insights",
    files: ["client/src/pages/ai-insights.tsx", "server/routes.ts"],
    additions: 312,
    deletions: 45,
    impact: "high",
    project: "vibe-coder",
  ...
  },
  {
    id: "commit-7",
    hash: "e6b4a9f",
    message: "feat: add command palette and global search functionality",
    author: "You",
    timestamp: new Date(Date.now() - 10 * 60 * 60 * 1000),
    branch: "feature/command-palette",
    files: ["client/src/components/ui/command-palette.tsx", "client/src/hooks/use-command-palette.ts"],
    additions: 189,
    deletions: 12,
    impact: "medium",
    project: "vibe-coder",
