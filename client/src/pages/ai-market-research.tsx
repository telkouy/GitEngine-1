            ...
            <Card className="w-full max-w-2xl">
              <CardHeader className="text-center pb-2">
                ...
                <p className="text-muted-foreground mt-2">
                  Investigación de mercado impulsada por IA súper avanzada 🧠
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="text-center">
                  <h3 className="text-lg font-semibold mb-3">Análisis profundo incoming:</h3>
                  <div className="grid gap-3 md:grid-cols-2">
                    <div className="flex items-center gap-3 p-3 rounded-lg border bg-card/50">
                      <TrendingUp className="h-5 w-5 text-primary" />
                      <span className="text-sm">Tendencias del mercado</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 rounded-lg border bg-card/50">
                    ...
                    <div className="flex items-center gap-3 p-3 rounded-lg border bg-card/50">
                      <Search className="h-5 w-5 text-primary" />
                      <span className="text-sm">Research automático</span>
                    </div>
                    <div className="flex items-center gap-3 p-3 rounded-lg border bg-card/50">
